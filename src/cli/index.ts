...
function printHelp(): void {
  console.log(`
not-my-opencode installer

Usage:
  bunx not-my-opencode install [OPTIONS]
  bunx not-my-opencode doctor [OPTIONS]
...
Examples:
  bunx not-my-opencode install
  bunx not-my-opencode install --no-tui --skills=yes
  bunx not-my-opencode install --preset=opencode-go
  bunx not-my-opencode install --reset
  bunx not-my-opencode doctor
`);
}
