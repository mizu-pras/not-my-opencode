...
const outputPath = join(rootDir, 'not-my-opencode.schema.json');
...
const jsonSchema = {
  ...
  title: 'not-my-opencode',
  description: 'Configuration schema for not-my-opencode plugin for OpenCode',
};
